type inputF = number | string

// function somarValores(input1: input, input2: input ) : number {} garante o retorno da função ser number
function somarValores(input1: inputF, input2: inputF ) { 
